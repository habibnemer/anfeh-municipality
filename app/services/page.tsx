...
const services = [
  ...
  { id: '6', type: 'suggestion', title_en: 'Suggestions', title_ar: 'اقتراحات', description_en: 'Share your ideas to help improve services and quality of life in Anfeh.', description_ar: 'شارك أفكارك للمساعدة في تحسين الخدمات وجودة الحياة في أنفه.', icon: 'Lightbulb', color: 'blue', details: 'We welcome ideas and suggestions from residents.' },
